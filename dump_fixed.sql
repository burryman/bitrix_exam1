...
INSERT INTO `b_admin_notify` VALUES (3,'MAIN','SITE_CHECKER','ÐžÐ±Ð½Ð°Ñ€ÑƒÐ¶ÐµÐ½Ñ‹ Ð¾ÑˆÐ¸Ð±ÐºÐ¸ Ð² Ñ€Ð°Ð±Ð¾Ñ‚Ðµ ÑÐ°Ð¹Ñ‚Ð°. <a href=\"/bitrix/admin/site_checker.php?lang=ru&start_test=Y\">ÐŸÑ€Ð¾Ð²ÐµÑ€Ð¸Ñ‚ÑŒ Ð¸ Ð¸ÑÐ¿Ñ€Ð°Ð²Ð¸Ñ‚ÑŒ.</a>','Y','N','M');
...
INSERT INTO `b_agent` VALUES (1,'main',100,'CEvent::CleanUpAgent();','Y','2017-09-22 11:30:29','2017-09-23 00:00:00',NULL,86400,'Y',NULL,'N'),(2,'main',100,'CUser::CleanUpHitAuthAgent();','Y','2017-09-22 11:30:29','2017-09-23 00:00:00',NULL,86400,'Y',NULL,'N'),(3,'main',100,'CCaptchaAgent::DeleteOldCaptcha(3600);','Y','2017-09-22 11:30:18','2017-09-22 12:30:18',NULL,3600,'N',NULL,'N'),(4,'main',100,'CUndo::CleanUpOld();','Y','2017-09-22 11:30:29','2017-09-23 00:00:00',NULL,86400,'Y',NULL,'N'),(5,'main',100,'CSiteCheckerTest::CommonTest();','Y','2017-09-22 11:30:18','2017-09-23 11:30:18',NULL,86400,'N',NULL,'N'),(6,'main',100,'\\Bitrix\\Main\\Analytics\\CounterDataTable::submitData();','Y','2017-09-22 11:37:29','2017-09-22 11:38:29',NULL,60,'N',NULL,'N'),(7,'forum',100,'CForumStat::CleanUp();','Y','2017-09-22 11:30:19','2017-09-23 11:30:19',NULL,86400,'N',NULL,'N'),(8,'forum',100,'CForumFiles::CleanUp();','Y','2017-09-22 11:30:19','2017-09-23 11:30:19',NULL,86400,'N',NULL,'N'),(9,'search',10,'CSearchSuggest::CleanUpAgent();','Y','2017-09-22 11:30:20','2017-09-23 11:30:20',NULL,86400,'N',NULL,'N'),(10,'search',10,'CSearchStatistic::CleanUpAgent();','Y','2017-09-22 11:30:20','2017-09-23 11:30:20',NULL,86400,'N',NULL,'N'),(11,'security',100,'CSecuritySession::CleanUpAgent();','Y','2017-09-22 11:30:19','2017-09-22 12:00:19',NULL,1800,'N',NULL,'N'),(12,'security',100,'CSecurityIPRule::CleanUpAgent();','Y','2017-09-22 11:30:19','2017-09-22 12:30:19',NULL,3600,'N',NULL,'N'),(13,'seo',100,'Bitrix\\Seo\\Engine\\YandexDirect::updateAgent();','Y','2017-09-22 11:30:19','2017-09-22 12:30:19',NULL,3600,'N',NULL,'N'),(14,'seo',100,'Bitrix\\Seo\\Adv\\LogTable::clean();','Y','2017-09-22 11:30:19','2017-09-23 11:30:19',NULL,86400,'N',NULL,'N'),(15,'seo',100,'Bitrix\\Seo\\Adv\\Auto::checkQuantityAgent();','Y','2017-09-22 11:30:20','2017-09-22 12:30:20',NULL,3600,'N',NULL,'N'),(16,'subscribe',100,'CSubscription::CleanUp();','Y','2017-09-22 11:30:29','2017-09-23 03:00:00',NULL,86400,'Y',NULL,'N'),(20,'socialservices',100,'CSocServMessage::CleanUp();','Y','2017-09-22 11:30:20','2017-09-23 11:30:20',NULL,86400,'N',NULL,'N');
...
INSERT INTO `b_bitrixcloud_option` VALUES (1,'backup_quota',0,'0','0'),(2,'backup_total_size',0,'0','0'),(3,'backup_last_backup_time',0,'0','1504872203'),(4,'monitoring_expire_time',0,'0','1506071253');
...
INSERT INTO `b_iblock_element_iprop` VALUES (5,0,33,2,'Вы сможете организовать внутри компании коллективную работу над проектами в рабочих группах, вести учет и планирование времени и событий, обмениваться сообщениями и почтой через портал, проводить внутри компании видеоконференции и делать многое другое.'),(5,0,33,3,'Отзыв - Cергей Родионов'),(5,0,33,4,'лучшие, отзывы, CTC-Медиа'),(5,0,33,5,'Отзыв - Cергей Родионов - CTC-Медиа'),(5,0,34,2,'Вы сможете организовать внутри компании коллективную работу над проектами в рабочих группах, вести учет и планирование времени и событий, обмениваться сообщениями и почтой через портал, проводить внутри компании видеоконференции и делать многое другое.'),(5,0,34,3,'Отзыв - Анна Андреева'),(5,0,34,4,'лучшие, отзывы, RK-Telecom'),(5,0,34,5,'Отзыв - Анна Андреева - RK-Telecom'),(5,0,35,2,'Можете сразу перейти с «младшей», базовой редакции на «Бизнес-процессы». После такого перехода ваш портал можно будет интегрировать с внешним сайтом, на портале добавятся возможности визуального проектирования бизнес-процессов и управления списками, включая списки в рабочих группах. Кроме того, вы сможете анализировать посещаемость своего портала'),(5,0,35,3,'Отзыв - Дмитрия Пялов'),(5,0,35,4,'лучшие, отзывы, .NET-девелопмент'),(5,0,35,5,'Отзыв - Дмитрия Пялов - .NET-девелопмент'),(5,0,36,2,'Можете сразу перейти с «младшей», базовой редакции на «Бизнес-процессы». После такого перехода ваш портал можно будет интегрировать с внешним сайтом, на портале добавятся возможности визуального проектирования бизнес-процессов и управления списками, включая списки в рабочих группах. Кроме того, вы сможете анализировать посещаемость своего портала.\r\nМожете сразу перейти с «младшей», базовой редакции на «Бизнес-процессы». После так'),(5,0,36,3,'Отзыв - Константин Эрнст'),(5,0,36,4,'лучшие, отзывы, Тест'),(5,0,36,5,'Отзыв - Константин Эрнст - Тест');
...
INSERT INTO `b_iblock_iproperty` VALUES (2,5,'ELEMENT_META_DESCRIPTION','B',5,'{=this.PreviewText}'),(3,5,'ELEMENT_META_TITLE','B',5,'Отзыв - {=this.Name}'),(4,5,'ELEMENT_META_KEYWORDS','B',5,'лучшие, отзывы, {=this.property.COMPANY}'),(5,5,'ELEMENT_PAGE_TITLE','B',5,'Отзыв - {=this.Name} - {=this.property.COMPANY}');
...
INSERT INTO `b_site_template` VALUES (16,'s1','',150,'exam1'),(17,'s1','CSite::InDir(\'/services/\')',151,'furniture_pale-blue');
...
INSERT INTO `b_undo` VALUES ('104b8779ac67deee5b0fae8dcfef50a89','fileman','edit_menu','CFileman::UndoEditFile','a:2:{s:7:\"absPath\";s:62:\"/home/burrman/public_html/bitrix.exam1/partners/.left.menu.php\";s:7:\"content\";s:255:\"<?\n$aMenuLinks = Array(\n	Array(\n		\"ÐšÐ°Ðº ÑÑ‚Ð°Ñ‚ÑŒ Ð¿Ð°Ñ€Ñ‚Ð½ÐµÑ€Ð¾Ð¼\", \n		\"become-partner.php\", \n		Array(), \n		Array(), \n		\"\" \n	),\n	Array(\n		\"Ð Ð°ÑÐ¿Ð¸ÑÐ°Ð½Ð¸Ðµ Ð¼ÐµÑ€Ð¾Ð¿Ñ€Ð¸ÑÑ‚Ð¸Ð¹\", \n		\"partners/timetable\", \n		Array(), \n		Array(), \n		\"\" \n	)\n);\n?>\";}',1,1506069087),('1707e40c002d332c222e195a3bbb71b8a','fileman','edit_menu','CFileman::UndoEditFile','a:2:{s:7:\"absPath\";s:62:\"/home/burrman/public_html/bitrix.exam1/partners/.left.menu.php\";s:7:\"content\";s:255:\"<?\n$aMenuLinks = Array(\n	Array(\n		\"ÐšÐ°Ðº ÑÑ‚Ð°Ñ‚ÑŒ Ð¿Ð°Ñ€Ñ‚Ð½ÐµÑ€Ð¾Ð¼\", \n		\"become-partner.php\", \n		Array(), \n		Array(), \n		\"\" \n	),\n	Array(\n		\"Ð Ð°ÑÐ¿Ð¸ÑÐ°Ð½Ð¸Ðµ Ð¼ÐµÑ€Ð¾Ð¿Ñ€Ð¸ÑÑ‚Ð¸Ð¹\", \n		\"partners/timetable\", \n		Array(), \n		Array(), \n		\"\" \n	)\n);\n?>\";}',1,1506069122),('1d75f9a3a18d52c4dc4057f2d2c474c4f','fileman','edit_menu','CFileman::UndoEditFile','a:2:{s:7:\"absPath\";s:62:\"/home/burrman/public_html/bitrix.exam1/partners/.left.menu.php\";s:7:\"content\";s:256:\"<?\n$aMenuLinks = Array(\n	Array(\n		\"ÐšÐ°Ðº ÑÑ‚Ð°Ñ‚ÑŒ Ð¿Ð°Ñ€Ñ‚Ð½ÐµÑ€Ð¾Ð¼\", \n		\"become-partner.php\", \n		Array(), \n		Array(), \n		\"\" \n	),\n	Array(\n		\"Ð Ð°ÑÐ¿Ð¸ÑÐ°Ð½Ð¸Ðµ Ð¼ÐµÑ€Ð¾Ð¿Ñ€Ð¸ÑÑ‚Ð¸Ð¹\", \n		\"partners/timetable/\", \n		Array(), \n		Array(), \n		\"\" \n	)\n);\n?>\";}',1,1506069107),('1e46e8323e197841fdddf2d21664e18f7','fileman','edit_menu','CFileman::UndoEditFile','a:2:{s:7:\"absPath\";s:62:\"/home/burrman/public_html/bitrix.exam1/partners/.left.menu.php\";s:7:\"content\";s:247:\"<?\n$aMenuLinks = Array(\n	Array(\n		\"ÐšÐ°Ðº ÑÑ‚Ð°Ñ‚ÑŒ Ð¿Ð°Ñ€Ñ‚Ð½ÐµÑ€Ð¾Ð¼\", \n		\"become-partner.php\", \n		Array(), \n		Array(), \n		\"\" \n	),\n	Array(\n		\"Ð Ð°ÑÐ¿Ð¸ÑÐ°Ð½Ð¸Ðµ Ð¼ÐµÑ€Ð¾Ð¿Ñ€Ð¸ÑÑ‚Ð¸Ð¹\", \n		\"timetable/\", \n		Array(), \n		Array(), \n		\"\" \n	)\n);\n?>\";}',1,1506069129),('1feacba6e260eb16c8951792645526ced','fileman','edit_menu','CFileman::UndoEditFile','a:2:{s:7:\"absPath\";s:62:\"/home/burrman/public_html/bitrix.exam1/partners/.left.menu.php\";s:7:\"content\";s:321:\"<?if(!defined(\"B_PROLOG_INCLUDED\") || B_PROLOG_INCLUDED!==true)die();?>\n<?\n$aMenuLinks = Array(\n	Array(\n		\"ÐšÐ°Ðº ÑÑ‚Ð°Ñ‚ÑŒ Ð¿Ð°Ñ€Ñ‚Ð½ÐµÑ€Ð¾Ð¼\", \n		\"become-partner.php\", \n		Array(), \n		Array(), \n		\"\" \n	),\n	Array(\n		\"Ð Ð°ÑÐ¿Ð¸ÑÐ°Ð½Ð¸Ðµ Ð¼ÐµÑ€Ð¾Ð¿Ñ€Ð¸ÑÑ‚Ð¸Ð¹\", \n		\"/timetable/\", \n		Array(), \n		Array(), \n		\"\" \n	),\n);\n?>\";}',1,1506069075);
...
INSERT INTO `b_user` VALUES (1,'2017-09-08 11:56:51','admin','adUgxPBYcde8d5a10398cfaa9770f2b6d88e0d16','2t2rQiLkdabf7b978dfeb9f4ed776af666822ef0','Y','','','admin@gmail.com','2017-09-22 11:30:39','2017-09-08 14:56:51',NULL,NULL,NULL,NULL,'',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2017-09-08 14:56:51',NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2017-09-22 11:51:19
